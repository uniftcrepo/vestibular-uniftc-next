...
const Home: NextPage = (props) => {
  ...
  return (
    <div className="App">
      <Head>
      <title>Vestibular UNIFTC 2024.1 - Inscreva-se</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <Script type="text/javascript" async 
        defer  src="https://cdn.cookielaw.org/scripttemplates/otSDKStub.js"   data-domain-script="2c4f05e0-8e56-444d-b47e-764fe164fd3d" ></Script>
